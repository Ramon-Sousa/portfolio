    ...
    <section className="mx-auto px-4 pb-2 sm:px-6 sm:pb-4 lg:px-8 lg:pb-40">
      <div className="mx-auto sm:pb-12 lg:pb-16">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="text-center text-slate-400 text-lg font-semibold ">
            UX & UI Designer com 4 anos de experiência, atuo criando recursos e
            documentações para otimizar processos deDiscovery e Delivery.
            Colaborei com time de dados, desenvolvedores, stakeholders para
            melhorar a experiência dousuário final. Já trabalhei como
            programador web e Front-end, possibilitando adquirir competências
            técnicas para odesenvolvimento das soluções propostas. Prestei
            serviço para grandes empresas, como Saint Gobain, Parceiro
            daConstrução e Branco motores.
          </div>
        </div>
      </div>
      <div className="flex justify-center">
        <div className="w-[479.29px] h-[104px] p-8 ] rounded-2xl border border-zinc-800 backdrop-blur-[14px] justify-center items-center gap-8 inline-flex">
          <div className="text-neutral-50 text-base font-semibold  leading-relaxed">
          ...
          <div className="justify-center items-center gap-6 flex">
            ...
            <a className="p-3 border-2 rounded-lg border-slate-100 relative" href="https://www.linkedin.com/in/ramon-sousa-pereira/" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
