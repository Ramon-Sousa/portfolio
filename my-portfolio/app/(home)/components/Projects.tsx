...
export default function Projects() {
  return (
    <div className="bg-transparent border-t-2 border-b-2 border-zinc-800">
      <div className="container grid grid-cols-2 gap-10 mx-auto px-4 py-4 sm:px-6 sm:py-12 lg:px-8 lg:py-40 ">
        <div className="">
          <div className=" text-slate-500 text-sm font-semibold font-['Nunito Sans'] uppercase">
            Portfolio
          </div>
          <div className="text-slate-200 text-[80px] font-black font-['Nunito Sans'] leading-snug">
            Projetos realizados
          </div>
          <div className=" text-slate-400 text-base font-normal font-['Nunito Sans'] pb-8">
            I craft amazing digital experiences through a selection of sought
            after services and offerings.
          </div>
          <button className="justify-center items-center gap-2 inline-flex rounded-full bg-white px-4 text-2xl text-black font-bold py-3">
            Ver todos
        ...
        <div className="flex flex-col gap-2">
          <div className="h-28 px-4 py-2 bg-[url('/assets/dot-grid.png')] rounded-2xl border border-slate-500 justify-between items-center inline-flex">
            <div className="justify-between items-center gap-4 flex">
              ...
              <div className="flex-col justify-start items-start gap-1.5 inline-flex">
                <div className="text-neutral-50 text-2xl font-semibold font-['Nunito Sans']">
                  Suflex
                </div>
                <div className="text-slate-500 text-sm font-bold font-['Nunito Sans']">
                  2024
                </div>
              </div>
            </div>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_1687_7157)">
                <path
      ...
      <div className="flex justify-center items-stretch h-60px py-3 bg-neutral-50">
        <div className="justify-center items-center gap-4 inline-flex">
          <div className="text-gray-800 text-2xl font-bold font-['Nunito Sans']">
