    ...
    <nav className="py-3 bg-transparent border-b border-gray-900 sticky top-0 z-10">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden sm:w-full sm:justify-end lg:flex lg:items-center lg:space-x-6">
          ...
          <p>·</p>
          <a href="https://www.linkedin.com/in/ramon-sousa-pereira/" target="blank" className="text-gray-100 hover:text-gray-400 text-sm">
          <Linkedin className="w-5" strokeWidth={1} />
          </a>
          <a href="https://github.com/Ramon-Sousa" target="blank" className="text-gray-100 hover:text-gray-400 text-md">
