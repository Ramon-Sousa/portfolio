...
export default function Description() {
  return (
    <section className="mx-auto px-4 pb-8 sm:px-6 lg:px-8 lg:pb-40" id="about">
      {/* <div className="sm:w-3/5 mx-auto pt-40 pb-16">
        <img
      ...
      {/* container px-0 mx-auto w-full sm:justify-center sm:mt-0 sm:grid auto-cols-max grid-cols-5 grid-rows-2 */}
      ...
      <div className="sm:container mx-auto text-center gap-4">
        ...
        <p className="text-gray-500 text-xl sm:text-3xl leading-8 sm:leading-10">
          ...
          <br />
          <br /> Minha experiência em desenvolvimento front-end e web design me
          permite unir o útil ao agradável, garantindo que minhas ideias sejam
          visualmente atraentes e tecnicamente viável. Nasci e cresci em Franca,
          uma cidade no interior de São Paulo, com um sotaque extremamente
          mineiro.
        </p>
      </div>
